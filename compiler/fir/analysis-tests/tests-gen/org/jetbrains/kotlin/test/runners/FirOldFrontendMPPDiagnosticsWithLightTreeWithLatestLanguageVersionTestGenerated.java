...
public class FirOldFrontendMPPDiagnosticsWithLightTreeWithLatestLanguageVersionTestGenerated extends AbstractFirLightTreeWithActualizerDiagnosticsWithLatestLanguageVersionTest {
  ...
  public class ContextParameters {
    ...
    public void testAllFilesPresentInContextParameters() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/diagnostics/tests/multiplatform/contextParameters"), Pattern.compile("^(.*)\\.kts?$"), Pattern.compile("^(.+)\\.(reversed|fir|ll|latestLV)\\.kts?$"), TargetBackend.JVM_IR, true);
    }

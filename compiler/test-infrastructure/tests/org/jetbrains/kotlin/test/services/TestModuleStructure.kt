...
fun TestModule.transitiveRegularDependencies(
    ...
    return transitiveDependencies(includeSelf = includeSelf, reverseOrder = reverseOrder) {
        it.relation == DependsOnDependency && filter(it)
    }
}
